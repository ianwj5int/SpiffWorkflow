...
class ProcessParser(object):
    ...
    def __init__(self, p, node, svg=None, filename=None, doc_xpath=None, absolute_global_task_id=None):
        """
        Constructor.
        ...
        self.spec = BpmnProcessSpec(name=self.get_id(), description=self.get_name(), svg=svg, filename=filename, absolute_global_task_id=absolute_global_task_id)
